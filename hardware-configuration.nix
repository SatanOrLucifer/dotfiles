...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/2c658042-9f21-4d04-9e54-fba91ee7cef9";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/65D6-84BE";
      fsType = "vfat";
      options = [ "fmask=0022" "dmask=0022" ];
    };
    
  fileSystems."/mnt/urithiru" =
    { device = "/dev/disk/by-uuid/e03f168f-8500-45d8-8fc2-72ccb6bb34ba";
      fsType = "ext4";
    };

  fileSystems."/mnt/roshar" =
  ...
  swapDevices =
    [ { device = "/dev/disk/by-uuid/b40f5d2a-efc7-40ba-9dc7-b03cbe866f2f"; }
    ];
